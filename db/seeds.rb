...
Doctor.create(title: 'MD', name: 'Jordan Adin', bio: Faker::Movies::Hobbit.quote, department_id: 10, email: 'jordanadin@tigonimed.edu', password: '123', doc: true)
15.times do
  Doctor.create(
    title: 'MD',
    ...
    email: "#{Faker::Internet.username}@tigonimed.edu",
...
Patient.create(name: "Hastings Anthony", age: rand(18..65), birthdate: Faker::Date.birthday(min_age: 18, max_age: 65), email: "hastingsantony1@gmail.com", password: "123", doc: false)
20.times do
  Patient.create(
    name: Faker::Movies::LordOfTheRings.character,
    age: rand(18..65),
